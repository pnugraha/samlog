...
(function(){
	$('input.currency').autoNumeric({aSep: '.', aDec: ',', aSign: 'Rp ', vMax: '9999999999999.99'});
	...
	$('input.angka').autoNumeric({aSep: '.', aDec: ',', aSign: '', vMax: '9999999999999.9999',aPad:false});
	$('input.angka').focus(function(){		
		if($(this).val()=='0'){
			$(this).val('');
		}
	});
	
	$('input.angka').blur(function(){
		if($(this).val()==''){
			$(this).val('0');
		}
	});
	
	$('input.persen').autoNumeric({aSep: '.', aDec: ',', aSign: '', vMax: '999.99',aPad:false});
	$('input.persen').focus(function(){		
		if($(this).val()=='0,00'){
			$(this).val('');
		}
	});
	
	$('input.persen').blur(function(){
		if($(this).val()==''){
			$(this).val('0,00');
		}
	});
