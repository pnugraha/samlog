    ...
    <div class="box-body">
        <div class="col-md-12" style="padding-bottom: 10px;">
            <div class="no-padding col-xs-6 clearfix" >
                <a href="{{ route('order_vendor.create') }}?order={{ $order }}&type={{ $type }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>      
            </div>
            ...
            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap tableview">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $v->service->pick_up }} - {{ $v->service->delivery }}</td>                        
                        <td>
                            @if($v->tax)
                            Yes
                            @else
                        ...
                        <td class="text-center">                            
                            <a title="Edit" class="text-black action-icon" href="{{ route('order_vendor.edit', $v->id) }}"><i class="fa fa-pencil-square-o"></i></a>
                            <form action="{{ route('order_vendor.destroy', $v->id) }}" method="POST" style="display: inline;" onsubmit="if (confirm('Anda yakin ingin menghapus data?')) {
                                        return true
                                    } else {
                                        return false
                                    }
